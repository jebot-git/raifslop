...
func run():
	...
	check(menu.tabs.get_child_count()==8 and menu.pages.has("bbq") and menu.pages.has("controls") and menu.pages.has("help"),"Eight section tabs including Controls and BBQ, plus header tutorial")
