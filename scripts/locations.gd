...
const CATALOG = [
	...
	{"id": "gray_pier", "name": "Gray Pier", "mood": "Reed-lined lake · Overcast", "description": "Reed boardwalk · Weathered timber over still, sheltered water.", "panorama": "res://assets/environment/locations/gray_pier_8k.hdr", "preview": "res://assets/environment/locations/gray_pier_preview.jpg", "yaw": 108.0, "sun_rotation": Vector3(-50, -40, 0), "sun_color": Color("d8e3ee"), "sun_energy": 0.08, "sky_energy": 0.8, "ambient": 0.48, "water": Color("263332"), "roughness": 0.28, "ripples": 0.22},
