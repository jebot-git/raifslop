...
static var CATALOG:Array = [
	...
	{"id": "bell_park_pier", "name": "Bell Park", "mood": "Hill reservoir · Afternoon", "description": "Moored boat · Walk aboard a fishing boat beneath green hills.", "panorama": "res://assets/environment/locations/bell_park_pier_8k.hdr", "preview": "res://assets/environment/locations/bell_park_pier_preview.jpg", "yaw": -72.0, "sun_rotation": Vector3(-28, 40, 0), "sun_color": Color("fff1d4"), "sun_energy": 0.4, "sky_energy": 0.42, "ambient": 0.38, "water": Color("1b3836"), "roughness": 0.3, "ripples": 0.55},
	{"id": "simons_town_rocks", "name": "Simon's Town", "mood": "Saltwater coast · Clear daylight", "description": "Rock-supported terrace with a weathered rope barrier overlooking a coastal bay.", "panorama": "res://assets/environment/locations/simons_town_rocks_8k.hdr", "preview": "res://assets/environment/locations/simons_town_rocks_preview.jpg", "yaw": 180.0, "sun_rotation": Vector3(-38, -65, 0), "sun_color": Color("fff7e6"), "sun_energy": .5, "sky_energy": .65, "ambient": .4, "water": Color("17333c"), "roughness": .26, "ripples": .9, "protect_panorama_foreground": true, "panorama_water_region": Vector4(.32,.69,.505,.66), "ground_bounds": Vector4(0,2,4.5,5)},
	{"id": "blouberg_sunrise_2", "sand_shore": true, "beach_sides": true, "name": "Blouberg", "mood": "Saltwater coast · Dawn surf", "description": "Walk a modeled sandy shore down to the surf.", "panorama": "res://assets/environment/locations/blouberg_sunrise_2_8k.hdr", "preview": "res://assets/environment/locations/blouberg_sunrise_2_preview.jpg", "yaw": 180.0, "sun_rotation": Vector3(-8, 95, 0), "sun_color": Color("ffd9b8"), "sun_energy": .16, "sky_energy": .8, "ambient": .4, "water": Color("354951"), "roughness": .5, "ripples": .45, "ground_bounds": Vector4(0,4.5,3.5,7.5), "ground_transition": Vector2(12,6)},
	{"id": "secluded_beach", "coastal_shallows": true, "name": "Secluded Beach", "mood": "Saltwater cove · Sheltered morning", "description": "A sandy pocket between rounded granite shoulders, with quiet water and a sheltered casting mouth.", "panorama": "res://assets/environment/locations/secluded_beach_8k.hdr", "preview": "res://assets/environment/locations/secluded_beach_preview.jpg", "yaw": 180.0, "sun_rotation": Vector3(-30,-30,0), "sun_color": Color("fff3dd"), "sun_energy": .5, "sky_energy": .65, "ambient": .4, "water": Color("27443e"), "roughness": .3, "ripples": .35, "protect_panorama_foreground": true, "panorama_water_region": Vector4(.36,.66,.505,.65), "ground_bounds": Vector4(0,3.5,6,6.5), "ground_transition": Vector2(9,7), "sand_shore": true, "beach_sides": true},
