...
static var CATALOG:Array = [
	...
	{"id": "blouberg_sunrise_2", "sand_shore": true, "beach_sides": true, "name": "Sunrise Beach", "mood": "Saltwater coast · Dawn surf", "description": "Walk a modeled sandy shore down to the surf.", "panorama": "res://assets/environment/locations/blouberg_sunrise_2_8k.hdr", "preview": "res://assets/environment/locations/blouberg_sunrise_2_preview.jpg", "yaw": 180.0, "sun_rotation": Vector3(-8, 95, 0), "sun_color": Color("ffd9b8"), "sun_energy": .16, "sky_energy": .8, "ambient": .4, "water": Color("354951"), "roughness": .5, "ripples": .45, "ground_bounds": Vector4(0,4.5,3.5,7.5), "ground_transition": Vector2(12,6)},
	{"id": "secluded_beach", "coastal_shallows": true, "name": "Secluded Cove", "mood": "Saltwater cove · Sheltered morning", "description": "A sandy pocket between rounded granite shoulders, with quiet water and a sheltered casting mouth.", "panorama": "res://assets/environment/locations/secluded_beach_8k.hdr", "preview": "res://assets/environment/locations/secluded_beach_preview.jpg", "yaw": 180.0, "sun_rotation": Vector3(-30,-30,0), "sun_color": Color("fff3dd"), "sun_energy": .5, "sky_energy": .65, "ambient": .4, "water": Color("27443e"), "roughness": .3, "ripples": .35, "protect_panorama_foreground": true, "panorama_water_region": Vector4(.36,.66,.505,.65), "ground_bounds": Vector4(0,3.5,6,6.5), "ground_transition": Vector2(9,7), "sand_shore": true, "beach_sides": true},
	{"id": "fish_hoek_beach", "coastal_shallows": true, "name": "Tidal Strand", "mood": "Saltwater beach · Misty morning", "description": "A broad pale-sand strand beneath misty hills, with scattered wrack, driftwood and soft rolling surf.", "panorama": "res://assets/environment/locations/fish_hoek_beach_8k.hdr", "preview": "res://assets/environment/locations/fish_hoek_beach_preview.jpg", "yaw": 180.0, "sun_rotation": Vector3(-10,30,0), "sun_color": Color("e5ebf2"), "sun_energy": .1, "sky_energy": .8, "ambient": .45, "water": Color("3e5058"), "roughness": .48, "ripples": .65, "ground_bounds": Vector4(0,3.5,10,6.5), "ground_transition": Vector2(12,8), "sand_shore": true, "beach_sides": true},
